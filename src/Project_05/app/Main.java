...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CalcCostBase costBase = new CalcCostBase(data[0], Integer.parseInt(data[1]), Double.parseDouble(data[2]));
        double baseCost = costBase.calcCost(product);
        // Розраховуємо вартість товару, з урахуванням доставки
        CalcCostDelivery costDelivery = new CalcCostDelivery(data[0], Integer.parseInt(data[1]), Double.parseDouble(data[2]));
